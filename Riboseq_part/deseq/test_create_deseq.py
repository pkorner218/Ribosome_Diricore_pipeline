...
if len(samples) > 2:
	...
	infile = open("deseq_template.R", "r")
	...
	for line in lines:
		...
		line = line.replace("sample1","'"+str(samples[1][1])+"'")
		line = line.replace("sample2","'"+str(samples[0][1])+"'")

		line = line.replace("condition1",conds[1])
		line = line.replace("condition2",conds[0])
